package com.sidhutechpvtltd.www.inventoryapp2;
...
import com.sidhutechpvtltd.www.inventoryapp2.data.ProductContract;
import com.sidhutechpvtltd.www.inventoryapp2.data.ProductCursorAdapter;
...
public class MainActivity extends AppCompatActivity implements android.app.LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public android.content.Loader<Cursor> onCreateLoader(int id, Bundle args) {
        // Read the required data using projection
        String[] projection = {
